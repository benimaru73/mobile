...
// A-1 : La conversion avec toLong() et toString() ressemble à ce qu'on fait en Java.
    val entier = montant.toLong().toString()

// A-3 : Je ne comprends pas encore bien pourquoi on inverse le nombre deux fois.
...
// A-2 : J'ai découvert ?.let : le calcul se fait seulement si le prix n'est pas null.
